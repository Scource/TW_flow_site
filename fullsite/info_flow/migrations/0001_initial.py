# Generated by Django 3.0.8 on 2020-10-21 15:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proc_assigned', models.ForeignKey(blank=True, null=True, on_delete=models.SET('1'), related_name='assigned_user', to=settings.AUTH_USER_MODEL)),
                ('proc_author', models.ForeignKey(on_delete=models.SET('1'), related_name='proc_user', to=settings.AUTH_USER_MODEL)),
